            ...
            <tbody>
              {coeffMentions.map((cm) => (
                <tr key={cm.id} className="border-b border-slate-100 hover:bg-slate-50">
                  ...
                  <td className="px-6 py-3">
                    <span className="bg-slate-100 text-slate-700 px-2 py-0.5 rounded text-xs font-semibold">{cm.niveau.nom}</span>
                  </td>
                  <td className="px-6 py-3 font-bold text-slate-700">{cm.coefficient}</td>
                  <td className="px-6 py-3 text-slate-600">{cm.professeur.nom} {cm.professeur.prenom}</td>
                </tr>
              ))}
            </tbody>
          </table>
